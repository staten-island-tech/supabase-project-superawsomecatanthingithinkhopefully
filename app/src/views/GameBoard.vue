<template>
  <div data-theme="synthwave" class="static min-h-screen relative flex flex-col" >
    ...
    <div class="relative top-0 left-0 z-0">
      ...
      <button class="absolute top-[12vw] left-[1vw] bg-purple-400 hover:bg-purple-700 text-white font-bold py-4 px-6 rounded-full" v-if="myTurn" @click ="game.turnOrder(id)" :disabled="isInitialPlacementPhase">end turn</button>
